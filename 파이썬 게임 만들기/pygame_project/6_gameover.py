...
character = pygame.image.load(os.path.join(image_path, "파이리.png"))
...
ball_images = [
    pygame.image.load(os.path.join(image_path, "공1.jpeg")),
    pygame.image.load(os.path.join(image_path, "공2.jpeg")),
    pygame.image.load(os.path.join(image_path, "공3.jpeg")),
    pygame.image.load(os.path.join(image_path, "공4.jpeg")),
]
...
balls.append(
    {
        ...
        "to_x": 3,  # x축 이동 방향, -3 이면 왼쪽, 3이면 오른 쪽
        "to_y": -6,  # y축 이동 방향
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        if ball_pos_x < 0 or ball_pos_x > screen_width - ball_height:
                    ...
                    balls.append(
                        {
                            ...
                            "to_x": -3,  # x축 이동 방향, -3 이면 왼쪽, 3이면 오른 쪽
                            "to_y": -6,  # y축 이동 방향
                            "init_spd_y": ball_speed_y[ball_idx],  # y 최초 속도
                        }
                    )
                    # 오른쪽으로 튕겨나가는 작은 공
                    balls.append(
